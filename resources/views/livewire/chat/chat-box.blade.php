    ...
    <div class="border-b flex flex-col overflow-y-scroll grow h-full">
        ...
        <main
            ...
            <div @class(['max-w-[85%] md:max-w-[78%] flex w-auto gap-2 relative mt-2'])>
                ...
                <!-- message body -->
                <div @class([
                    'flex flex-wrap text-[15px]  rounded-xl p-2.5 flex flex-col text-black bg-[#f6f6f8f]',
                    'rounded-bl-none border  border-gray-200/40 ' => false,
                    'rounded-br-none bg-blue-500/80 text-white' => true,
                ])>
                    <p class="whitespace-normal truncate text-sm md:text-base tracking-wide lg:tracking-normal"> Lorem
                        ipsum
                        dolor sit amet consectetur adipiscing elit. Labore voluptatum rerum tenetur auten,
                        fugiat sunt repudiandae.
                    </p>

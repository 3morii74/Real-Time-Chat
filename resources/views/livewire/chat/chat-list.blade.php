            ...
            @if ($conversations)
                @foreach ($conversations as $conversation)
                    <li id="conversation-{{ $conversation->id }}" wire:key="{{ $conversation->id }}"
                        class="py-3 hover:bg-gray-50 rounded-2xl dark:hover:bg-gray-700/70 transition-colors duration-150 flex gap-4 relative w-full cursor-pointer px-2 {{ $conversation->id == $selectedConversation?->id ? 'bg-gray-300' : '' }}">
                            ...
                            <a href="{{ route('chat', $conversation->id) }}"
                                ...
                                <div class="flex gap-x-2 items-center">
                                    ...
                                    <p class="grow truncate text-sm font-[100]">
                                        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Animi quod modi
                                        cumque aut! Numquam ea atque placeat praesentium laborum, sapiente, fuga in ut
                                        enim ipsa eum officiis maiores! Qui, voluptas?
                                    </p>
